...
//Uncomment this is GLCD 8 bit is used
//****************************************
#define GLCD_4bit
//*****************************************

#define DATA_PORT		PORTA
#define DATAPORT_DIR    DDRA
#define DATA_PIN		PINA
#define COMMAND_PORT    PORTB
#define COMMAND_DIR     DDRB
...
#define DATA_IN()	DATAPORT_DIR &= ~0xFF
#define DATA_PORT_OUT()	DATAPORT_DIR |= 0xFF
